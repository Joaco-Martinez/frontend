      ...
      <div className="flex items-center justify-center">
        <section className="bg-[#4A0E1B] text-white py-16 px-6 md:px-16 w-full mx-auto flex flex-col md:flex-row items-center justify-center">
          ...
          <div className="relative mt-12 md:mt-0 md:ml-10 flex items-end">
            {/* Desktop preview */}
            <div className="bg-[#FCEAE5] text-black w-[320px] h-[200px] rounded-xl shadow-lg flex items-center justify-center text-center border border-black">
            ...
            {/* Mobile preview */}
            <div className="bg-[#FCEAE5] text-black w-[100px] h-[180px] rounded-xl shadow-lg flex items-center justify-center text-center border border-black absolute -right-8 -bottom-6">
